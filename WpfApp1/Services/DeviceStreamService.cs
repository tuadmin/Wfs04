...
{
    //TODO: Доделать и перенести с FileStream на этот
    public class DeviceStreamService : Stream, IDisposable
    {
        ...
        public const uint CREATE_ALWAYS = 2; // Creates a new file, always. (rewrite if exist)
        ...
        public DeviceStreamService(string path)
        {
            ...
            IntPtr ptr = CreateFile(path, GENERIC_READ, NO_SHARE, IntPtr.Zero, OPEN_EXISTING, 0, IntPtr.Zero);
        ...
        public override int ReadByte()
        {
            ...
            if (!ReadFile(
                _handle.DangerousGetHandle(), // handle to file
